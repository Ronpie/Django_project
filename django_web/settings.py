...
SECRET_KEY = 't7inp7uf2zs!dchtu@)4+ze+@ih288#r74d05#8280(93l1ymd'
...
"""
Where to add new application to out apps
Easy for django looks for template
...
#when user login redirect them to homepage
# instead of their profile accounts/profile/
